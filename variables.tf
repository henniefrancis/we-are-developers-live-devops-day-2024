...
variable "default_tags" {
  ...
  default = {
    ...
    repository  = "we-are-developers-live-devops-day-2024"
    workload    = "common"
    environment = "dev"
  }
}
...
variable "google_project" {
  ...
  default = {
    wearedevelopers = "we-are-developers-live-devops-day-2024"
  }
}